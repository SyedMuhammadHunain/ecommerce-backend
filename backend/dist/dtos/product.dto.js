...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'Name of product is required' }),
    (0, class_validator_1.Matches)(/^[A-Za-z0-9\s]+$/),
    __metadata("design:type", String)
], ProductDto.prototype, "productName", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'Price of product is required' }),
    __metadata("design:type", String)
], ProductDto.prototype, "price", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'Description is required' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Length)(15, 500, {
